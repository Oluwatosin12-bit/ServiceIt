...
const updateAppointmentCount = async(docRef, COUNT_CHANGE, batchWrite)=>{
  ...
  batchWrite.update(docRef, {AppointmentCount: appointmentCount+COUNT_CHANGE})
}
...
export {fetchLocations, handleDeletePost, updateAppointmentCount, updateFavoriteCount}
